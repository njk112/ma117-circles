/*
 * PROJECT I: Project1.java naglis
 *
...
public class Point {
    ...
    */
     ...
     */   
    public double getX() {
	// You need to fill in this method. - Filled
	    return X;
    }
	...
	// You need to fill in this method. -- FILLED
	    return Math.sqrt(Math.pow(x.X - X,2) + Math.pow(x.Y - Y,2));
    }
    ...
    public static void main (String args[]) {
	    ...
	    Point start = new Point(1.123213,1.1412312);
	    Point end = new Point(-1.123123,10.44444);
	    
	    System.out.println("X Start: " + start.getX());
	    System.out.println("Y Start: " + start.getY());
	    System.out.println(start.toString());
	
    	System.out.println("X End: " + end.getX());
	    System.out.println("Y End: " + end.getY());	
	    System.out.println(end.toString());
	    
    	System.out.println("Start-End distance: " + start.distance(end));
    	System.out.println("Equal: " + start.equals(end));
